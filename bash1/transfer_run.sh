...
function fpga_trig () {
    ../tools/reg_rw /dev/xdma1_user 0x30018 w 0x00000000 #disable trig
	../tools/reg_rw /dev/xdma1_user 0x30020 w 0x22222222 #trig
	../tools/reg_rw /dev/xdma1_user 0x30018 w 0x000000FF #enable trig
}
...
function fpga_fps () {
	...
	#15fps 13333333
	#10fps 20000000
    ../tools/reg_rw /dev/xdma1_user 0x30024 w 20000000
    ../tools/reg_rw /dev/xdma1_user 0x30028 w 20000000
    ../tools/reg_rw /dev/xdma1_user 0x3002c w 20000000
    ../tools/reg_rw /dev/xdma1_user 0x30030 w 20000000
    ../tools/reg_rw /dev/xdma1_user 0x30034 w 20000000
    ../tools/reg_rw /dev/xdma1_user 0x30038 w 20000000
    ../tools/reg_rw /dev/xdma1_user 0x3003c w 20000000
    ../tools/reg_rw /dev/xdma1_user 0x30040 w 20000000
}
...
#transfer_start ${transfer_file_replay[@]} ${transfer_file_name[@]} ${transfer_file_type[@]}
#./send_test_cam0.sh
#./send_test_cam1.sh
#./send_test_cam2.sh &
#./send_test_cam3.sh &
#./send_test_cam0_cam1.sh
